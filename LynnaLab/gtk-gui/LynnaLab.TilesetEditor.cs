...
namespace LynnaLab
{
	public partial class TilesetEditor
	{
		...
		private global::LynnaLab.SpinButtonHexadecimal tilesetLayoutSpinButton;

		private global::LynnaLab.ComboBoxFromConstants uniqueGfxComboBox;

		private global::Gtk.VBox vbox1;

		private global::LynnaLab.TilesetViewer tilesetviewer1;
		...
		protected virtual void Build()
		{
			...
			// Widget LynnaLab.TilesetEditor
			global::Stetic.BinContainer.Attach(this);
			this.Name = "LynnaLab.TilesetEditor";
			// Container child LynnaLab.TilesetEditor.Gtk.Container+ContainerChild
			...
			this.tilesetSpinButton.Adjustment.Upper = 255D;
			...
			this.hbox2.Add(this.tilesetSpinButton);
            hbox2.SetChildPacking(tilesetSpinButton, false, false, 0, Gtk.PackType.Start);
			this.vbox2.Add(this.hbox2);
            vbox2.SetChildPacking(hbox2, false, false, 0, Gtk.PackType.Start);
			// Container child vbox2.Gtk.Box+BoxChild
			...
			this.label3.LabelProp = global::Mono.Unix.Catalog.GetString("Layout");
			...
			// Container child table2.Gtk.Table+TableChild
			this.tilesetLayoutSpinButton = new global::LynnaLab.SpinButtonHexadecimal();
			this.tilesetLayoutSpinButton.CanFocus = true;
			this.tilesetLayoutSpinButton.Name = "tilesetLayoutSpinButton";
			this.tilesetLayoutSpinButton.Adjustment.Upper = 100D;
			this.tilesetLayoutSpinButton.Adjustment.PageIncrement = 16D;
			this.tilesetLayoutSpinButton.Adjustment.StepIncrement = 1D;
			this.tilesetLayoutSpinButton.ClimbRate = 1D;
			this.tilesetLayoutSpinButton.Digits = ((uint)(2));
			this.tilesetLayoutSpinButton.Numeric = true;
			this.table2.Add(this.tilesetLayoutSpinButton);
			global::Gtk.Table.TableChild w18 = ((global::Gtk.Table.TableChild)(this.table2[this.tilesetLayoutSpinButton]));
            ...
            hbox1.SetChildPacking(table2, false, false, 0, Gtk.PackType.Start);
			// Container child hbox1.Gtk.Box+BoxChild
			this.vbox1 = new global::Gtk.VBox();
			this.vbox1.Name = "vbox1";
			this.vbox1.Spacing = 6;
			// Container child vbox1.Gtk.Box+BoxChild
			this.tilesetviewer1 = new global::LynnaLab.TilesetViewer();
			this.tilesetviewer1.WidthRequest = 256;
			this.tilesetviewer1.HeightRequest = 256;
			this.tilesetviewer1.Name = "tilesetviewer1";
			this.vbox1.Add(this.tilesetviewer1);
            vbox1.SetChildPacking(tilesetviewer1, false, false, 0, Gtk.PackType.Start);
			this.hbox1.Add(this.vbox1);
            hbox1.SetChildPacking(vbox1, false, false, 0, Gtk.PackType.Start);
			// Container child hbox1.Gtk.Box+BoxChild
            ...
            hbox1.SetChildPacking(frame1, false, false, 0, Gtk.PackType.Start);
			// Container child hbox1.Gtk.Box+BoxChild
            ...
            vbox2.SetChildPacking(frame2, false, false, 0, Gtk.PackType.Start);
			// Container child vbox2.Gtk.Box+BoxChild
            ...
            vbox2.SetChildPacking(alignment1, false, false, 0, Gtk.PackType.End);
			this.Add(this.vbox2);
			if ((this.Child != null))
			{
				this.Child.ShowAll();
			...
			this.tilesetLayoutSpinButton.ValueChanged += new global::System.EventHandler(this.OnTilesetLayoutSpinButtonValueChanged);

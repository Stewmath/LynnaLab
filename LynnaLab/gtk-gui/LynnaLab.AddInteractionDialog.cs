...
namespace LynnaLab
{
	public partial class AddInteractionDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget LynnaLab.AddInteractionDialog
			this.Name = "LynnaLab.AddInteractionDialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child LynnaLab.AddInteractionDialog.VBox
			...
			this.hbox1.Add (this.typeSpinButton);
			global::Gtk.Box.BoxChild w2 = ((global::Gtk.Box.BoxChild)(this.hbox1 [this.typeSpinButton]));
			w2.Position = 1;
			w2.Expand = false;
			w2.Fill = false;
			// Container child hbox1.Gtk.Box+BoxChild
			...
			w4.Expand = false;
			w4.Fill = false;
			// Internal child LynnaLab.AddInteractionDialog.ActionArea
